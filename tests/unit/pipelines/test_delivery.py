...
@patch('core_workshop.pipelines.run_05_delivery.algorithm.oss_uploader.upload_to_oss')
def test_upload_dataset_success(mock_upload, temp_output_dir):
    """测试数据集上传成功"""
    from core_workshop.pipelines.run_05_delivery.algorithm.oss_uploader import upload_dataset
